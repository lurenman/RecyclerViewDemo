package com.example.administrator.recyclerviewdemo.views;
...
import com.example.administrator.recyclerviewdemo.utils.ScreenUtil;
...
public class SlidingMenu extends HorizontalScrollView {
    ...
    private void onOpenMenu() {
        ...
        ((SlideMenuAdapter1) ((RecyclerView) view).getAdapter()).holdOpenMenu(this);
        isOpen = true;
    }
    ...
    private void closeOpenMenu() {
        if (!isOpen) {
            ...
            ((SlideMenuAdapter1) ((RecyclerView) view).getAdapter()).closeOpenMenu();
        }
    }
